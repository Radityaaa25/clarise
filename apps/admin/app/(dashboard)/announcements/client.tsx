    ...
    <div className="space-y-6">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-muted-foreground font-bold mt-2">
            Manage global banners and notifications for users.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="neo-card p-6 h-fit bg-card">
          <h3 className="text-xl font-black uppercase text-foreground border-b-2 border-border pb-2 mb-4">
            Create Announcement
          </h3>
          <div className="space-y-4">
            <div>
              <label className="block text-sm text-muted-foreground font-bold mb-1">
                Title
              </label>
              <input
                type="text"
