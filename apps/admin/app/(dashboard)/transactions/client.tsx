    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
          ...
          <p className="text-muted-foreground font-bold mt-2">
            Track payments, subscriptions, and revenue history.
          </p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="neo-card bg-card p-6">
          <h3 className="text-muted-foreground font-bold uppercase text-sm mb-2">
          ...
          <table className="w-full text-left border-collapse min-w-[800px]">
            ...
            <tbody className="divide-y-2 divide-border">
              {transactions.map((tx) => (
                ...
                >
                  <td className="px-6 py-4 font-mono text-sm text-muted-foreground font-bold border-r-2 border-border">
                    {tx.id}
                  </td>
                  ...
                  <td className="px-6 py-4 text-right text-muted-foreground font-bold text-sm">
                    {tx.date}
                  </td>
                </tr>
              ))}
