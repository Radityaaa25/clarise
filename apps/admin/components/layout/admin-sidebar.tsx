  ...
  return (
    <aside className="w-64 border-r-2 border-border h-screen sticky top-0 bg-card flex flex-col z-40">
      <div className="p-6 border-b-2 border-border">
        <Link
          href="/"
          className="flex items-center overflow-hidden gap-3 -mb-10 -mt-10"
        >
          <Image
            ...
            priority
          />
          <span className="text-sm font-bold px-2 py-0.5 bg-secondary text-secondary-foreground border-2 border-border hidden lg:block">
            Admin
          </span>
        </Link>
      </div>
      ...
      <div className="p-4 border-t-2 border-border space-y-2 bg-card">
        <Link
          href="/settings"
          className="w-full flex items-center gap-3 px-3 py-3 font-bold border-2 border-transparent text-muted-foreground hover:border-border hover:bg-secondary hover:text-secondary-foreground hover:neo-shadow-sm transition-all"
        >
