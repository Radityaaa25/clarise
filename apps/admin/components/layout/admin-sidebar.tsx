...
const NAV_ITEMS = [
  ...
  { href: "/courses", label: "Courses & Moderation", icon: BookOpen },
    ...
    <aside className="w-64 border-r-2 border-border h-screen sticky top-0 bg-card flex flex-col z-40">
      <div className="p-6 border-b-2 border-border">
        <Link href="/" className="flex items-center overflow-hidden gap-3 -mb-10 -mt-10">
          <img src="/logoDM.png" alt="Clarise Admin" className="w-[120px] h-auto object-contain dark:hidden" />
          <img src="/logoLM.png" alt="Clarise Admin" className="w-[120px] h-auto object-contain hidden dark:block" />
