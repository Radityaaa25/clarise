        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' http://localhost:3000 https://app.clarise.my.id https://*.supabase.co https://*.clerk.accounts.dev https://*.ingest.sentry.io https://generativelanguage.googleapis.com https://*.upstash.io",
