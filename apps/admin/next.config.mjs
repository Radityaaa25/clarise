    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://clerk.com https://*.clerk.accounts.dev https://clerk.clarise.my.id https://accounts.clarise.my.id https://*.posthog.com https://challenges.cloudflare.com",
              ...
              "connect-src 'self' http://localhost:3000 https://app.clarise.my.id https://*.supabase.co https://*.clerk.accounts.dev https://clerk.clarise.my.id https://accounts.clarise.my.id https://*.posthog.com https://us.i.posthog.com https://generativelanguage.googleapis.com https://*.upstash.io",
