...
export default function OnboardingPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-canvas text-ink dark:text-white relative overflow-hidden transition-colors duration-300">
