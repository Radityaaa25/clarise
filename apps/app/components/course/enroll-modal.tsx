        ...
        {isFreeUser && isPremiumCourse ? (
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-body dark:text-white/70 mb-8">
              Berlangganan untuk mengakses lebih banyak course tingkat menengah
              hingga lanjutan.
            </p>
          ...
          /* Condition 2: Reached Limit Block */
          <div className="flex flex-col items-center text-center">
            <div className="w-12 h-12 bg-spark/10 text-spark rounded-full flex items-center justify-center mb-4">
              <Sparkles size={24} />
            </div>
            ...
            <h3 className="text-2xl font-bold text-ink dark:text-white mb-2">
              Batas kursus tercapai
            </h3>
            <p className="text-body dark:text-white/70 mb-8">
              Batas kursus tercapai. Berlangganan untuk mengakses lebih banyak
              kursus.
            </p>
            <div className="flex flex-col gap-3 w-full">
              <a
