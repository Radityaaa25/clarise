        ...
        headers: [
          ...
          // Content Security Policy
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.supabase.co https://*.clerk.accounts.dev https://clerk.clarise.my.id https://accounts.clarise.my.id https://*.posthog.com https://us.i.posthog.com https://generativelanguage.googleapis.com https://*.upstash.io",
